...
use shairplay::raop::video::{VideoHandler, VideoSession, VideoPacket, PacketKind};
        ...
        match packet.kind {
            ...
            PacketKind::Payload => {
                ...
                match self.decoder.decode(&decode_buf) {
                    ...
                    let pixels: Vec<u32> = rgb.chunks_exact(3)
