...
pub fn garble(buffer0: &mut [u8; 20], buffer1: &mut [u8; 210], buffer2: &mut [u8; 35], buffer3: &mut [u8; 132], buffer4: &[u8; 21]) {
    ...
    buffer2[12] = (0x14u32 + ((((buffer1[64] as u32) & 92) | (((buffer1[99] as u32) / 3) & 35)) & (buffer4[(rol8x(buffer4[(buffer1[206] as usize) % 21], 4) as usize) % 21] as u32))) as u8;

    // C: buffer1[4] = (buffer1[99] / 5) * (buffer1[99] / 5) * 2;
    buffer1[4] = (((buffer1[99] as u32) / 5) * ((buffer1[99] as u32) / 5) * 2) as u8;

    // C: buffer2[34] = 0xb8;
    buffer2[34] = (0xb8u32) as u8;

    // C: buffer1[153] ^= (buffer2[buffer1[203] % 35] * buffer2[buffer1[203] % 35] * buffer1[190]);
    buffer1[153] ^= (((buffer2[(buffer1[203] as usize) % 35] as u32) * (buffer2[(buffer1[203] as usize) % 35] as u32) * (buffer1[190] as u32))) as u8;
    ...
    buffer3[0] = (92 - (buffer2[(buffer1[32] as usize) % 35] as u32)) as u8;

    // C: buffer3[4] = buffer2[buffer1[15] % 35] + 0x9e;
    buffer3[4] = ((buffer2[(buffer1[15] as usize) % 35] as u32) + 0x9eu32) as u8;

    // C: buffer1[34] += (buffer4[((buffer2[buffer1[15] % 35] + 0x9e) & 0xff) % 21] / 5);
    buffer1[34] = buffer1[34].wrapping_add(((buffer4[(((buffer2[(buffer1[15] as usize) % 35] as u32) + 0x9eu32) & 0xffu32) as usize % 21] / 5)) as u8);

    // C: buffer0[19] += 0xfffffee6 - ((buffer0[buffer3[4] % 20]>>1) & 102);
    buffer0[19] = buffer0[19].wrapping_add((0xfffffee6u32 - (((buffer0[(buffer3[4] as usize) % 20] as u32)>>1) & 102)) as u8);
    ...
    buffer1[15] = ((3*((((buffer1[72] as u32) >> ((buffer4[(buffer1[190] as usize) % 21] as u32) & 7)) ^ ((buffer1[72] as u32) << ((7 - ((buffer4[(buffer1[190] as usize) % 21] as u32)-1)&7)))) - (3*(buffer4[(buffer1[126] as usize) % 21] as u32)))) ^ (buffer1[15] as u32)) as u8;

    // C: buffer0[15] ^= buffer2[buffer1[181] % 35] * buffer2[buffer1[181] % 35] * buffer2[buffer1[181] % 35];
    buffer0[15] ^= ((buffer2[(buffer1[181] as usize) % 35] as u32) * (buffer2[(buffer1[181] as usize) % 35] as u32) * (buffer2[(buffer1[181] as usize) % 35] as u32)) as u8;

    // C: buffer2[4] ^= buffer1[202]/3;
    buffer2[4] ^= ((buffer1[202] as u32)/3) as u8;

    // C: A = 92 - buffer0[buffer3[0] % 20];
    A = 92 - (buffer0[(buffer3[0] as usize) % 20] as u32);

    // C: E = (A & 0xc6) | (!buffer1[105] & 0xc6) | (A & (!buffer1[105]));
    E = (A & 0xc6u32) | (!(buffer1[105] as u32) & 0xc6u32) | (A & (!(buffer1[105] as u32)));

    // C: buffer2[1] += (E*E*E);
    buffer2[1] = buffer2[1].wrapping_add(((E*E*E)) as u8);

    // C: buffer0[19] ^= ((224 | (buffer4[buffer1[92] % 21] & 27)) * buffer2[buffer1[41] % 35]) / 3;
    buffer0[19] ^= (((224 | ((buffer4[(buffer1[92] as usize) % 21] as u32) & 27)) * (buffer2[(buffer1[41] as usize) % 35] as u32)) / 3) as u8;
    ...
    A = (buffer1[177] as u32) + (buffer4[(buffer1[79] as usize) % 21] as u32);

    // C: D = (((A >> 1) | ((3 * buffer1[148]) / 5)) & buffer2[1]) | ((A >> 1) & ((3 * buffer1[148])/5));
    D = (((A >> 1) | ((3 * (buffer1[148] as u32)) / 5)) & (buffer2[1] as u32)) | ((A >> 1) & ((3 * (buffer1[148] as u32))/5));
    ...
    A = 8 - (((buffer2[22] as u32) & 7));     // FIXME: (buffer2[22] as u32) = 74, so A is always 6 and B^C is just ror8((buffer1[33] as u32), 6);
    ...
    buffer2[16] = buffer2[16].wrapping_add(((((buffer2[(buffer3[0] as usize) % 35] as u32) & 159) | (buffer0[(buffer3[4] as usize) % 20] as u32) | 8) - ((B^C) | 128)) as u8);
    ...
    buffer2[8] = (weird_ror8(140, (((buffer4[(buffer1[45] as usize) % 21] as u32) + 92) * ((buffer4[(buffer1[45] as usize) % 21] as u32) + 92)) & 7)) as u8;
    ...
    buffer3[16] = ((A*A) + 110) as u8;

    // C: buffer3[20] = 202 - buffer3[16];
    buffer3[20] = (202 - (buffer3[16] as u32)) as u8;
    ...
    B = (((buffer2[(buffer1[179] as usize) % 35] as u32) - 38) & 177) | ((buffer3[12] as u32) & 177);

    // C: C = ((buffer2[buffer1[179] % 35] - 38)) & buffer3[12];
    C = (((buffer2[(buffer1[179] as usize) % 35] as u32) - 38)) & (buffer3[12] as u32);

    // C: buffer3[28] = 30 + ((B | C) * (B | C));
    buffer3[28] = (30 + ((B | C) * (B | C))) as u8;

    // C: buffer3[32] = buffer3[28] + 62;
    buffer3[32] = ((buffer3[28] as u32) + 62) as u8;

    // C: A = ((buffer3[20] + (buffer3[0] & 74)) | !buffer4[buffer3[0] % 21]) & 121;
    A = (((buffer3[20] as u32) + ((buffer3[0] as u32) & 74)) | !(buffer4[(buffer3[0] as usize) % 21] as u32)) & 121;

    // C: B = ((buffer3[20] + (buffer3[0] & 74)) & !buffer4[buffer3[0] % 21]);
    B = (((buffer3[20] as u32) + ((buffer3[0] as u32) & 74)) & !(buffer4[(buffer3[0] as usize) % 21] as u32));
    ...
    buffer1[47] = (((buffer2[(buffer1[89] as usize) % 35] as u32) + C) ^ (buffer1[47] as u32)) as u8;

    // C: buffer3[36] = (((rol8(((tmp & 179) + 68) as u8, 2) as u32) & buffer0[3]) | (tmp2 & !buffer0[3])) - 15;
    buffer3[36] = ((((rol8(((tmp & 179) + 68) as u8, 2) as u32) & (buffer0[3] as u32)) | (tmp2 & !(buffer0[3] as u32))) - 15) as u8;

    // C: buffer1[123] ^= 221;
    buffer1[123] ^= (221) as u8;

    // C: A = ((buffer4[buffer3[0] % 21]) / 3) - buffer2[buffer3[4] % 35];
    A = (((buffer4[(buffer3[0] as usize) % 21] as u32)) / 3) - (buffer2[(buffer3[4] as usize) % 35] as u32);
    ...
    buffer3[64] = ((buffer3[4] as u32) + ((((((((buffer3[40] as u32) | (buffer3[24] as u32)) & 177) | ((buffer3[40] as u32) & (buffer3[24] as u32))) & (((((buffer4[(buffer3[0] as usize) % 20] as u32) & 177) | 176)) | (((buffer4[(buffer3[0] as usize) % 21] as u32)) & !3u32))) | (((((buffer3[40] as u32) & (buffer3[24] as u32)) | (((buffer3[40] as u32) | (buffer3[24] as u32)) & 177)) & 199) | (((((buffer4[(buffer3[0] as usize) % 21] as u32) & 1) + 176) | ((buffer4[(buffer3[0] as usize) % 21] as u32) & !3u32)) & (buffer3[56] as u32)))) & (!(buffer3[52] as u32))) | (buffer3[48] as u32))) as u8;
    ...
    buffer2[30] = ((((buffer3[64] as u32) / 3) - (275 | ((buffer3[0] as u32) & 247))) ^ (buffer0[(buffer1[122] as usize) % 20] as u32)) as u8;
    ...
    buffer2[18] = buffer2[18].wrapping_add((((A*A*A) >> 1)) as u8);
    ...
    A = ((((buffer1[41] as u32) & !24u32)|((buffer2[(buffer1[183] as usize) % 35] as u32) & 24)) & ((buffer3[16] as u32) + 53)) | ((buffer3[20] as u32) & (buffer2[(buffer3[20] as usize) % 35] as u32));
    ...
    buffer2[22] = ((((((B | weird_rol8(((buffer2[(buffer3[0] as usize) % 35] as u32) as u8), A)) & (buffer2[33] as u32)) | (B & weird_rol8(((buffer2[(buffer3[0] as usize) % 35] as u32) as u8), A))) + 74) & 0xffu32)) as u8;
    ...
    D = (((((buffer3[0] as u32)/3) - ((buffer3[64] as u32)|(buffer1[22] as u32)))) ^ ((buffer3[28] as u32) + 62) ^ ((B|C)));
    ...
    buffer3[68] = (((buffer0[(buffer1[99] as usize) % 20] as u32) * (buffer0[(buffer1[99] as usize) % 20] as u32) * (buffer0[(buffer1[99] as usize) % 20] as u32) * (buffer0[(buffer1[99] as usize) % 20] as u32)) | (buffer2[(buffer3[64] as usize) % 35] as u32)) as u8;
    ...
    M = ((buffer3[40] as u32) & (buffer4[(((buffer3[8] as u32) + J + E) & 0xffu32) as usize % 21] as u32)) |
      (((buffer3[40] as u32) | (buffer4[(((buffer3[8] as u32) + J + E) & 0xffu32) as usize % 21] as u32)) & (buffer2[23] as u32));

    // C: buffer0[15] = (((buffer4[buffer3[20] % 21] - 48) & (!buffer1[184])) | ((buffer4[buffer3[20] % 21] - 48) & 189) | (189 & !buffer1[184])) & (M*M*M);
    buffer0[15] = (((((buffer4[(buffer3[20] as usize) % 21] as u32) - 48) & (!(buffer1[184] as u32))) | (((buffer4[(buffer3[20] as usize) % 21] as u32) - 48) & 189) | (189 & !(buffer1[184] as u32))) & (M*M*M)) as u8;
    ...
    buffer3[76] = ((3 * (buffer4[(buffer1[1] as usize) % 21] as u32)) ^ (buffer3[0] as u32)) as u8;

    // C: A = buffer2[((buffer3[8] + (J + E)) & 0xff) % 35];
    A = (buffer2[((((buffer3[8] as u32) + (J + E)) & 0xffu32) as usize) % 35] as u32);

    // C: F = (((buffer4[buffer1[178] % 21] & A) | ((buffer4[buffer1[178] % 21] | A) & 209)) * buffer0[buffer1[13] % 20]) * (buffer4[buffer1[26] % 21] >> 1);
    F = ((((buffer4[(buffer1[178] as usize) % 21] as u32) & A) | (((buffer4[(buffer1[178] as usize) % 21] as u32) | A) & 209)) * (buffer0[(buffer1[13] as usize) % 20] as u32)) * ((buffer4[(buffer1[26] as usize) % 21] as u32) >> 1);

    // C: G = (F + 0x733ffff9) * 198 - (((F + 0x733ffff9) * 396 + 212) & 212) + 85;
    G = (F + 0x733ffff9u32) * 198 - (((F + 0x733ffff9u32) * 396 + 212) & 212) + 85;

    // C: buffer3[80] = buffer3[36] + (G ^ 148) + ((G ^ 107) << 1) - 127;
    buffer3[80] = ((buffer3[36] as u32) + (G ^ 148) + ((G ^ 107) << 1) - 127) as u8;
    ...
    buffer2[18] = buffer2[18].wrapping_sub((((A*A*A) & !(buffer0[15] as u32)) | (((buffer3[80] as u32) / 15) & (buffer0[15] as u32))) as u8);

    // C: buffer3[88] = buffer3[8] + J + E - buffer0[buffer1[160] % 20] + (buffer4[buffer0[((buffer3[8] + J + E) & 255) % 20] % 21] / 3);
    buffer3[88] = ((buffer3[8] as u32) + J + E - (buffer0[(buffer1[160] as usize) % 20] as u32) + ((buffer4[(buffer0[((((buffer3[8] as u32) + J + E) & 255) as usize) % 20] as usize) % 21] as u32 / 3))) as u8;

    // C: B = ((R ^ buffer3[72]) & !198) | ((S * S) & 198);
    B = ((R ^ (buffer3[72] as u32)) & !198u32) | ((S * S) & 198);

    // C: F = (buffer4[buffer1[69] % 21] & buffer1[172]) | ((buffer4[buffer1[69] % 21] | buffer1[172] ) & ((buffer3[12] - B) + 77));
    F = ((buffer4[(buffer1[69] as usize) % 21] as u32) & (buffer1[172] as u32)) | (((buffer4[(buffer1[69] as usize) % 21] as u32) | (buffer1[172] as u32) ) & (((buffer3[12] as u32) - B) + 77));

    // C: buffer0[16] = 147 - ((buffer3[72] & ((F & 251) | 1)) | (((F & 250) | buffer3[72]) & 198));
    buffer0[16] = (147 - (((buffer3[72] as u32) & ((F & 251) | 1)) | (((F & 250) | (buffer3[72] as u32)) & 198))) as u8;
    ...
    // C: buffer1[164] += ((A*A)/5);
    buffer1[164] = buffer1[164].wrapping_add((((A*A)/5)) as u8);
    ...
    C = (((buffer4[(buffer3[64] as usize) % 21] as u32) * (buffer4[(buffer3[64] as usize) % 21] as u32) * (buffer4[(buffer3[64] as usize) % 21] as u32)) & 95) | ((buffer0[(buffer3[40] as usize) % 20] as u32) & !95u32);
    ...
    buffer1[143] = ((buffer3[96] as u32) - ((B & (86 + (((buffer1[172] as u32) & 64) >> 1))) | ((((((buffer1[172] as u32) & 65) >> 1) ^ 86) | ((!(buffer3[64] as u32) & ((buffer3[84] as u32) / 3)) | ((((buffer3[40] as u32) & !(buffer2[8] as u32)) | ((buffer1[35] as u32) & (buffer2[8] as u32))) & (buffer3[64] as u32)))) & (buffer3[100] as u32)))) as u8;
    ...
    B = (buffer2[(buffer1[149] as usize) % 35] as u32) ^ ((buffer1[43] as u32) * (buffer1[43] as u32));
    ...
    buffer3[120] = ((buffer3[64] as u32) - (buffer0[(buffer3[40] as usize) % 20] as u32)) as u8;
    ...
    A = weird_ror8(buffer2[(buffer3[80] as usize) % 35], ((buffer2[(buffer1[17] as usize) % 35] as u32) * (buffer2[(buffer1[17] as usize) % 35] as u32) * (buffer2[(buffer1[17] as usize) % 35] as u32)) & 7);

    // C: buffer0[7] -= (A*A);
    buffer0[7] = buffer0[7].wrapping_sub(((A*A)) as u8);

    // C: buffer2[8] = buffer2[8] - buffer1[184] + (buffer4[buffer1[202] % 21] * buffer4[buffer1[202] % 21] * buffer4[buffer1[202] % 21]);
    buffer2[8] = ((buffer2[8] as u32) - (buffer1[184] as u32) + ((buffer4[(buffer1[202] as usize) % 21] as u32) * (buffer4[(buffer1[202] as usize) % 21] as u32) * (buffer4[(buffer1[202] as usize) % 21] as u32))) as u8;
    ...
    buffer0[7] = buffer0[7].wrapping_sub((((buffer0[(buffer1[191] as usize) % 20] as u32) - ((((buffer4[(buffer1[80] as usize) % 21] as u32) << 1) & !177u32) | ((buffer4[(buffer4[(buffer3[88] as usize) % 21] as usize) % 21] as u32) & 177)))) as u8);
    ...
    buffer0[12] = (((buffer0[(buffer3[84] as usize) % 20] as u32) ^ ((buffer2[(buffer1[71] as usize) % 35] as u32) + (buffer2[(buffer1[15] as usize) % 35] as u32))) & ((A & B) | ((A | B) & 27))) as u8;
    ...
    H = (buffer0[(buffer3[40] as usize) % 20] as u32) * (buffer0[(buffer3[40] as usize) % 20] as u32) * (buffer0[(buffer3[40] as usize) % 20] as u32);
    ...
    buffer2[25] ^= ((((buffer0[(buffer3[120] as usize) % 20] as u32) << 1) * (buffer1[5] as u32)) - (weird_rol8(((buffer3[76] as u32) as u8), ((buffer4[(buffer3[124] as usize) % 21] as u32) & 7)) & ((buffer3[20] as u32) + 110))) as u8;
