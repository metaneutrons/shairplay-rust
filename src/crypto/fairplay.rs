...
fn modified_md5(original_block_in: &[u8], key_in: &[u8; 16], key_out: &mut [u8; 16]) {
    ...
    block_in[..64.min(original_block_in.len())]
        .copy_from_slice(&original_block_in[..64.min(original_block_in.len())]);
...
mod playfair_tests {
    ...
    fn md5_real_block() {
        let block: [u8; 64] = [
            0xfa, 0x9c, 0xad, 0x4d, 0x4b, 0x68, 0x26, 0x8c, 0x7f, 0xf3, 0x88, 0x99, 0xde, 0x92,
            0x2e, 0x95, 0x1e, 0xef, 0xbf, 0x61, 0x64, 0x43, 0xab, 0x48, 0x6b, 0x70, 0x0a, 0x3f,
            0x74, 0x3d, 0xf2, 0x0d, 0xdd, 0x71, 0x85, 0x35, 0x46, 0xf2, 0xef, 0x51, 0x5d, 0x63,
            0xe2, 0x7a, 0x37, 0xc5, 0x10, 0xde, 0x09, 0x71, 0x85, 0x35, 0x46, 0xf2, 0xef, 0x51,
            0x5d, 0x63, 0xe2, 0x7a, 0x37, 0xc5, 0x10, 0xde,
        ];
        let key: [u8; 16] = [
            0xdc, 0xdc, 0xf3, 0xb9, 0x0b, 0x74, 0xdc, 0xfb, 0x86, 0x7f, 0xf7, 0x60, 0x16, 0x72,
            0x90, 0x51,
        ];
        let mut out = [0u8; 16];
